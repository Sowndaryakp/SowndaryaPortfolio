  ...
  return (
    <section className="bg-white py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto bg-pink-100 shadow-md rounded-lg p-8">
          ...
          <form>
            <div className="mb-4 flex">
              <div className="w-1/2 mr-2">
                <input type="text" id="name" name="name" placeholder="Name *" required className="mt-1 p-2 border border-gray-300 rounded-md w-full focus:outline-none " />
              </div>
              <div className="w-1/2 ml-2">
                <input type="email" id="email" name="email" placeholder="Email *" required className="mt-1 p-2 border border-gray-300 rounded-md w-full focus:outline-none " />
              </div>
            </div>
            <div className="mb-4">
              <textarea id="message" name="message" placeholder="Message *" rows="4" required className="mt-1 p-2 border border-gray-300 rounded-md w-full focus:outline-none resize-none"></textarea>
            </div>
            <button className="bg-white text-charm-600 font-semibold py-4 px-6 rounded-full border border-charm-600 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-opacity-50 hover:bg-charm-500 hover:text-white transition-colors duration-200">
                Send Message
            </button>
          </form>
        </div>
